...
<html>
    ...
    <body>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $nro = mysqli_real_escape_string($conn,$_REQUEST['nro']);

            $disciplina = mysqli_real_escape_string($conn,$_REQUEST['disciplina']);
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                $cadastro_error = "Algo de errado aconteceu com o cadastro. Erro: " . $conn->error;
            }
