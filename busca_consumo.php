...
<html>
    ...
    <body>
        ...
        $sql_inicio = "SELECT * FROM `consumo`";
            ...
            <form method="post" class="form-horizontal" role="form">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Editar Consumo</h4>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="edit_consumo_id" value="<?php echo $id; ?>">
                            <div class="form-group">
                                ...
                                <label class="control-label col-sm-2" for="senha">Status:</label>
                                <div class="col-sm-4">
               ...
               <?php if($status==2){echo '<option value="2" selected >Emprestado</option>';} ?>   
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="update_consumo"><span class="fa fa-pencil-square-o"></span> Editar</button>
            ...
            <div class="modal-dialog">
                <form method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Deletar Consumo</h4>
                        </div>

                        <div class="modal-body">
                            <input type="hidden" name="delete_id" value="<?php echo $id; ?>">
                            <p>
                                <div class="alert alert-danger">Você tem certeza que deseja deletar <strong><?php echo $nome; ?>?</strong></p>
                            </div>
                            <div class="modal-footer">
        ...
        <?php
                        ...
                        //Update Items
                        if(isset($_POST['update_consumo'])){
                            $edit_consumo_id = $_POST['edit_consumo_id'];
                            $nome = $_POST['nome'];
                            $status= $_POST['status'];
                            ...
                            $sql = "UPDATE consumo SET 
                                ...
                                WHERE id=$edit_consumo_id ";
                            if ($conn->query($sql) === TRUE) {
                                echo '<script>window.location.href="busca_consumo.php"</script>';
                            } else {
                        ...
                        if(isset($_POST['delete'])){
                            ...
                            $sql = "DELETE FROM consumo WHERE id='$delete_id' ";
                            if ($conn->query($sql) === TRUE) {
